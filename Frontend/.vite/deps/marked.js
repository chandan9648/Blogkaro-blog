...
`, e = e.substring(G.length + 1), d = E.slice(f);
  ...
  table(e) {
    ...
    let n = V(t[1]), s = t[2].replace(this.rules.other.tableAlignChars, "").split("|"), i = ((_a2 = t[3]) == null ? void 0 : _a2.trim()) ? t[3].replace(this.rules.other.tableRowBlankLine, "").split(`
...
`), this.blockTokens(e, this.tokens);
  ...
  blockTokens(e, t = [], n = false) {
    ...
    for (this.options.pedantic && (e = e.replace(m.tabCharGlobal, "    ").replace(m.spaceLine, "")); e; ) {
      let s;
      if ((_b = (_a2 = this.options.extensions) == null ? void 0 : _a2.block) == null ? void 0 : _b.some((r) => (s = r.call({ lexer: this }, e, t)) ? (e = e.substring(s.raw.length), t.push(s), true) : false)) continue;
...
` + s.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = r.text) : t.push(s);
  ...
  inlineTokens(e, t = []) {
    ...
    for (; e; ) {
      i || (r = ""), i = false;
      let o;
      if ((_b = (_a2 = this.options.extensions) == null ? void 0 : _a2.inline) == null ? void 0 : _b.some((c) => (o = c.call({ lexer: this }, e, t)) ? (e = e.substring(o.raw.length), t.push(o), true) : false)) continue;
      ...
      if (o = this.tokenizer.reflink(e, this.tokens.links)) {
        ...
        let c = t.at(-1);
        o.type === "text" && (c == null ? void 0 : c.type) === "text" ? (c.raw += o.raw, c.text += o.text) : t.push(o);
        continue;
      }
      ...
      if (o = this.tokenizer.inlineText(l)) {
        ...
        let c = t.at(-1);
        (c == null ? void 0 : c.type) === "text" ? (c.raw += o.raw, c.text += o.text) : t.push(o);
        continue;
      }
      if (e) {
...
var $ = class {
  ...
  code({ text: e, lang: t, escaped: n }) {
    var _a2;
    let s = (_a2 = (t || "").match(m.notSpaceStart)) == null ? void 0 : _a2[0], i = e.replace(m.endingNewline, "") + `
`;
...
`;
  ...
  listitem(e) {
    ...
    if (e.task) {
      ...
      e.loose ? ((_a2 = e.tokens[0]) == null ? void 0 : _a2.type) === "paragraph" ? (e.tokens[0].text = n + " " + e.tokens[0].text, e.tokens[0].tokens && e.tokens[0].tokens.length > 0 && e.tokens[0].tokens[0].type === "text" && (e.tokens[0].tokens[0].text = n + " " + R(e.tokens[0].tokens[0].text), e.tokens[0].tokens[0].escaped = true)) : e.tokens.unshift({ type: "text", raw: n + " ", text: n + " ", escaped: true }) : t += n + " ";
    }
...
var B = class {
  ...
  walkTokens(e, t) {
    ...
    for (let s of e) switch (n = n.concat(t.call(this, s)), s.type) {
      ...
      default: {
        let i = s;
        ((_b = (_a2 = this.defaults.extensions) == null ? void 0 : _a2.childTokens) == null ? void 0 : _b[i.type]) ? this.defaults.extensions.childTokens[i.type].forEach((r) => {
          let o = i[r].flat(1 / 0);
